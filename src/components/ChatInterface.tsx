...
export const ChatInterface = () => {
  ...
  return (
    <div className="flex h-screen bg-chat-background flex-col">
      {/* Header with wallet connect button */}
      <header className="absolute top-0 right-0 bg-transparent border-b border-transparent p-4 flex justify-end z-10">
        <WalletConnect />
      </header>
